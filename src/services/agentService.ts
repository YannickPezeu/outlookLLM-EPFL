...
- Deux outils thématiques à bien distinguer :
  ...
  * summarize_topic_status — POINT D'AVANCEMENT chronologique d'un projet/dossier en cours. Utiliser pour "où on en est de X ?", "état d'avancement de Y ?", "fais-moi un point sur Z", "résume l'avancée du dossier W".
  ATTENTION SUJET vs PERSONNE : ces deux outils (et le skill sujet_dossier) sont pour un THÈME/dossier. Si la demande nomme une PERSONNE ou une liste de personnes ("la situation avec Sandrine", "fais le point sur mes échanges avec X et Y"), N'utilise PAS summarize_topic_status (il ratisse toute la boîte sans cibler la personne) — charge le skill summarize_emails et appelle summarize_email_interactions pour chaque personne.
